...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x12(
        ...
        KC_LCTL, KC_BTN1, KC_RALT, KC_LGUI, MO(2),   KC_SPC,  KC_SPC,  MO(1),   KC_LEFT,  KC_DOWN, KC_UP,    KC_RGHT
    ),  
	[1] = LAYOUT_ortho_5x12(
	...
	[3] = LAYOUT_ortho_5x12(
        DF(0),   DF(4),   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,   KC_F12,
