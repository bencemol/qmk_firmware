...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_5x12(
        KC_GESC, KC_1,    KC_2,    KC_3,  KC_4,  KC_5,   KC_6,   KC_7,  KC_8,    KC_9,    KC_0,    TD(TD_LBRC_RBRC_BSLS),
	...
	[3] = LAYOUT_ortho_5x12(
        ...
        KC_NO, KC_NO,  MU_MOD, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, DF(0),   DF(4),    KC_NO,  KC_NO,  KC_NO,
